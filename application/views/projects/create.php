...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="mt-1">
                <div class="card">
                    <h4 class=" card-header"><i class="mdi mdi-account"></i> &nbsp; Project</h4>
                    <div class="card-body">
                        <form action="<?= base_url('Project/create_project')?>" method="POST">
                            <div class="row">
                                ...
                                <?php (form_error('client')) ? $this->load->view('components/error_toster', ['error'=>form_error('client')]) : null ; ?>
                                    ...
                                    <select id="inputClient" class="form-select" name="client">
                                ...
                                <?php (form_error('project_category')) ? $this->load->view('components/error_toster', ['error'=>form_error('project_category')]) : null ; ?>
                                    ...
                                    <select id="inputProjectCategory" class="form-select" name="project_category">
                                        <option>Choose</option>
                                ...
                                <?php (form_error('start_date')) ? $this->load->view('components/error_toster', ['error'=>form_error('start_date')]) : null ; ?>
                                    ...
                                    <input type="date" class="form-control" id="inputStart_date"  name="start_date">
                                </div>
                                ...
                                <?php (form_error('end_date')) ? $this->load->view('components/error_toster', ['error'=>form_error('end_date')]) : null ; ?>
                                    ...
                                    <input type="date" class="form-control" id="inputEnd_date"  name="end_date">
                                </div>
